  ...
  return (
    <main className="min-h-screen bg-gray-100 text-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-5 py-5">
        ...
        {message && (
          <div className="mb-4 bg-white border border-gray-200 rounded-lg px-4 py-3 flex items-center justify-between">
            ...
            <div className="px-6 py-5">
              ...
              <div className="mt-4 rounded-lg border border-green-100 bg-green-50 px-4 py-3">
                ...
                <p className="text-xs leading-5 text-green-700">
                  Approving this payment will confirm the related
                  orders and generate one QR receipt for this checkout.
                </p>
